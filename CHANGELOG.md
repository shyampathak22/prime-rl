...
- **`orchestrator.env.reward_keys`**: Added list of metric keys to use as reward signals for multi-reward advantage computation (GDPO). When set, enables per-reward normalization before aggregation (2026-01-14)
